...
def create_real_estate_invert_index(data):
    ...
    dump(address_invert_index, os.path.join(ROOT_DIR,"search_engine","address_invert_index.lib"))
    dump(content_invert_index, os.path.join(ROOT_DIR,"search_engine","content_invert_index.lib"))
    dump(type_invert_index, os.path.join(ROOT_DIR,"search_engine","type_invert_index.lib"))
