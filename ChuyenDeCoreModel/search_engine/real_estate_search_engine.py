...
class RealEstateSearchEngine:
    def __init__(self, address_weight = 2/5, content_weight = 1/5, type_weight = 2/5, max_result = 100):
        self.address_invert_index : InvertIndex = load("address_invert_index.lib")
        self.content_invert_index : InvertIndex = load("content_invert_index.lib")
        self.type_invert_index : InvertIndex = load("type_invert_index.lib")
